...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/specialisms/high-risk" },
  openGraph: {
    title:
...
export default function HighRiskPage() {
  return (
    <main id="main-content" className="relative">
      ...
      <ServiceSchema
        name="High Risk Insurance"
        description="Specialist cover for demolition, asbestos removal, hot works, work at height, airside contractors, and environmental impairment. NFDC and DSA-affiliated."
        url="https://crs-ins.co.uk/specialisms/high-risk"
      />
      <Nav />
