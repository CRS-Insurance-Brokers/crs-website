...
import { FAQPageSchema, BreadcrumbSchema, ServiceSchema } from "../../components/SchemaJsonLd";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/specialisms/engineering" },
  openGraph: {
...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    a: "When you hire equipment to others, your liability as the owner relates to the condition of the equipment at the point of hire. What the hirer does with it is generally their liability.",
  },
  {
  ...
  return (
    <main id="main-content" className="relative">
      ...
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://crs-ins.co.uk/" },
        { name: "Specialisms", url: "https://crs-ins.co.uk/specialisms" },
        { name: "Engineering Insurance" },
      ]} />
      <ServiceSchema
        name="Engineering Insurance"
        description="Specialist cover for mechanical and electrical engineers, machinery, hired-in plant, and specialist engineering trades. Tools, machinery in transit, and M&E-specific liability."
        url="https://crs-ins.co.uk/specialisms/engineering"
      />
      <Nav />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-start">
              ...
              <div className="lg:col-span-6 flex flex-col gap-5 lg:self-center lg:mt-10">
                <p className="text-[15px] md:text-[16px] leading-[1.7] text-m-bone/65">
                  M&E businesses and engineering operations don&rsquo;t fit a
                  standard commercial policy. Your tools and machinery move.
                  What you own and what you hire in changes job to job. And
                  your liability as an engineer doesn&rsquo;t stop at practical
                  completion — it follows the system you installed.
                </p>
                <p className="text-[15px] md:text-[16px] leading-[1.7] text-m-bone/65">
                  We put together a programme around what you own, what you
                  hire in, and the full scope of your work. No
                  standard package.{" "}
                  <span className="text-white">A schedule built around how you run.</span>
                </p>
              </div>
            </div>
          </Reveal>
