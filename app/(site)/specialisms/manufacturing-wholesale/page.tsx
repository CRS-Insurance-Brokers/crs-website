...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/specialisms/manufacturing-wholesale" },
  openGraph: {
  ...
  return (
    <main id="main-content" className="relative">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Manufacturing & Wholesale Insurance" },
      ]} />
      <ServiceSchema
        name="Manufacturing & Wholesale Insurance"
        description="Commercial combined, machinery breakdown, and business interruption cover for manufacturers, wholesalers, and distributors. Industrial plant, warehousing, and supply chain exposure."
        url="https://crs-ins.co.uk/specialisms/manufacturing-wholesale"
      />
      <Nav />
