...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/specialisms/construction" },
  openGraph: {
...
export default function ConstructionPage() {
  return (
    <main id="main-content" className="relative">
      ...
      <ServiceSchema
        name="Construction Insurance"
        description="Cover for principal contractors, subcontractors, civils, groundworks, and specialist trades. Contractors All Risks, professional indemnity, and JCT-aligned cover."
        url="https://crs-ins.co.uk/specialisms/construction"
      />
      <Nav />
